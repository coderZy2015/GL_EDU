...
import com.gl.education.home.interactive.SearchJCInteractive;
...
public class SearchResultJCFragment extends BaseFragment {
    ...
    public static SearchResultJCFragment newInstance(String url, String searchStr) {
        SearchResultJCFragment frag = new SearchResultJCFragment();
        Bundle b = new Bundle();
    ...
    public void onLazyInitView(@Nullable Bundle savedInstanceState) {
        ...
        mAgentWeb.getJsInterfaceHolder().addJavaObject("android", new SearchJCInteractive(mAgentWeb,
                getActivity()));
    ...
    public void toBookMenuEvent(JSSearchJCOpenWebViewEvent event) {
