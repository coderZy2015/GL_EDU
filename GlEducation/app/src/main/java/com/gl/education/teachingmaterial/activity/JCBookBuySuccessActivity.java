...
import com.gl.education.teachingmaterial.interactive.JCBookBuySuccessInteractive;
...
public class JCBookBuySuccessActivity extends BaseActivity {
    ...
    protected int provideContentViewId() {
        return R.layout.activity_jcbook_buy_success;
    }
    ...
    public void initView() {
        ...
        mAgentWeb.getJsInterfaceHolder().addJavaObject("android", new JCBookBuySuccessInteractive(mAgentWeb,
                this));
