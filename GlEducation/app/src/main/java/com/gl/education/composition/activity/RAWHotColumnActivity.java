...
import com.gl.education.composition.interactive.RAWHotColumnInteractive;
 ...
 * 热点素材
 */
public class RAWHotColumnActivity extends BaseActivity {
    ...
    protected int provideContentViewId() {
        return R.layout.activity_rawhot_column;
    }
    ...
    public void initView() {
        ...
        top_title.setText("热点素材");

        String token = SPUtils.getInstance().getString(AppConstant.SP_TOKEN);
        token = "?token=" + token;
        String url = AppConstant.YY_WEB_COMPOSITION_RAW_HOTCOLUMN + token;
        ...
        mAgentWeb.getJsInterfaceHolder().addJavaObject("android", new RAWHotColumnInteractive
                (mAgentWeb,
                this));
    }
    ...
    public void getHotColumn(JSgetHotColumnEvent event) {
        HomeAPI.getCatalog("2", new JsonCallback<GetHotColumnBean>() {
            @Override
    ...
    //
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void openList(JSopenListEvent event) {
