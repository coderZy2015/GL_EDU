...
import com.gl.education.home.adapter.RechargeRecordAdapter;
...
public class RechargeRecordActivity extends BaseActivity {
    ...
    public void initView() {
        ...
        //适配器参数：item布局、列表数据源
        adapter = new RechargeRecordAdapter(R.layout.item_transaction_record, mList);
        //设置数据
        ...
        HomeAPI.getOrderRecord(new JsonCallback<GetOrderRecordBean>() {
            ...
            public void onSuccess(Response<GetOrderRecordBean> response) {
                ...
                if (response.body().getResult() == 1000){
                    mList.clear();
                    mList.addAll(response.body().getData().getRechargeOrder());
