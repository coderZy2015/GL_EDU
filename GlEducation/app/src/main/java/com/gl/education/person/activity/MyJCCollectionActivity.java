...
import com.gl.education.person.interactive.MyJCCollectionInteractive;
...
public class MyJCCollectionActivity extends BaseActivity {
    ...
    protected int provideContentViewId() {
        return R.layout.activity_mine_jccollection;
    }
    ...
    public void initView() {
        ...
        mAgentWeb.getJsInterfaceHolder().addJavaObject("android", new MyJCCollectionInteractive(mAgentWeb,
                this));
    }
    ...
    public void toBookDetailEvent(MyJCCollectionOpenWebViewEvent event) {
