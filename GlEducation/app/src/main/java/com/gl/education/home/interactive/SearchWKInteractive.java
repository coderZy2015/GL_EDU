...
public class SearchWKInteractive {

    private AgentWeb mAgentWeb;
    private Context context;

    public SearchWKInteractive(AgentWeb agent, Context context) {
    ...
    public void openWebview(String json){
        ...
        JSSearchWKOpenWebViewEvent event = new JSSearchWKOpenWebViewEvent();
        event.setBean(bean);
