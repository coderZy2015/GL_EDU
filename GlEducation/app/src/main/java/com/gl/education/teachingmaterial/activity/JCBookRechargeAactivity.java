...
import com.gl.education.teachingmaterial.interactive.JCBookRechargeInteractive;
...
public class JCBookRechargeAactivity extends BaseActivity {
    ...
    protected int provideContentViewId() {
        return R.layout.activity_jcbook_recharge_aactivity;
    }
    ...
    //发起支付请求   获取预订单  调起微信
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onWXPayMoneyEvent(JSJCBookWXPayEvent event) {
                            ...
                            if (wxPreOrderBean != null) {
                                try {
                                    ...
                                    builder.setAppId(appId)
                                            ...
                                            (JCBookRechargeAactivity.this, appId);
    ...
    //发起支付请求   获取预订单  调起支付宝
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void onZFBPayMoneyEvent(JSJCBookZFBPayEvent event) {
        JSPayInfoBean bean = event.getBean();
        if (bean != null) {
