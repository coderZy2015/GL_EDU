...
public class MyALipayUtils {
    ...
    private MyALipayUtils(ALiPayBuilder builder, String _tag, String id) {
    ...
    public void toALiPay(final Activity context) {
        ...
        Log.e("zy_code", "toALiPay: " + orderInfo);
    ...
    private Map<String, String> buildOrderParamMap(boolean rsa2) {
        ...
        keyValues.put("biz_content", "{\"timeout_express\":\"30m\"," +
                "\"product_code\":\"QUICK_MSECURITY_PAY\",\"total_amount\":\"" + builder.money +
                "\",\"subject\":\"" + builder.title + "\",\"out_trade_no\":\"" + builder
                .orderTradeId + "\"}");
    ...
    public static class ALiPayBuilder {
        ...
        public MyALipayUtils build(String tag, String id) {
            return new MyALipayUtils(this, tag, id);
        }
