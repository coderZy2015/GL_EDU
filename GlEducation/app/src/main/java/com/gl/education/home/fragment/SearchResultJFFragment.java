...
public class SearchResultJFFragment extends BaseFragment{
    ...
    public static SearchResultJFFragment newInstance(String url, String searchStr) {
        SearchResultJFFragment frag = new SearchResultJFFragment();
        Bundle b = new Bundle();
    ...
    public void onLazyInitView(@Nullable Bundle savedInstanceState) {
        ...
        mAgentWeb.getJsInterfaceHolder().addJavaObject("android", new SearchJFInteractive(mAgentWeb,
                getActivity()));
    ...
    public void toBookMenuEvent(JSSearchJFOpenWebViewEvent event) {
