...
import com.gl.education.home.interactive.SearchZXInteractive;
...
public class SearchResultZXFragment extends BaseFragment {
    ...
    public static SearchResultZXFragment newInstance(String url, String searchStr) {
        SearchResultZXFragment frag = new SearchResultZXFragment();
        Bundle b = new Bundle();
    ...
    public void onLazyInitView(@Nullable Bundle savedInstanceState) {
        ...
        mAgentWeb.getJsInterfaceHolder().addJavaObject("android", new SearchZXInteractive(mAgentWeb,
                getActivity()));
    ...
    public void intoContentView(JSSearchZXOpenWebViewEvent event) {
