...
public class JFBookBuySuccessActivity extends BaseActivity {
    ...
    protected int provideContentViewId() {
        return R.layout.activity_jfbook_buy_success;
    }
    ...
    public void initView() {
        ...
        mAgentWeb.getJsInterfaceHolder().addJavaObject("android", new JFBookBuySuccessInteractive(mAgentWeb,
                this));
    }
