 ...
 * 代币充值界面
 */
public class JFBookRechargeAactivity extends BaseActivity {
    ...
    protected int provideContentViewId() {
        return R.layout.activity_jfbook_recharge_aactivity;
    }

    @Override
    protected String setIdentifier() {
        return "JFBookRechargeAactivity";
    }
    ...
    public void paySuccess(JSJFBookRechargeOpenWebViewEvent event) {
        ...
        intent.setClass(this, JFBookPaySuccessActivity.class);
                            ...
                            if (wxPreOrderBean != null) {
                                try {
                                    ...
                                    builder.setAppId(appId)
                                            ...
                                            (JFBookRechargeAactivity.this, appId);
                        ...
                        public void onSuccess(Response<AliPayOrderBean> response) {
                            ...
                            try {
                                if (responseData.getResult() == 1000) {
                                    ...
                                    builder.build(eventTAG, orderId).toALiPay(JFBookRechargeAactivity
