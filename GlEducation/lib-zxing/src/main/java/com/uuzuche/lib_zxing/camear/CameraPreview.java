...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback, Camera.AutoFocusCallback {
    private static final String TAG = "zy_code";

    private int viewWidth = 0;
    private int viewHeight = 0;

    private boolean cameraParamsInit = false;
    ...
    public boolean getCameraParamsInit(){
        return cameraParamsInit;
    }
    ...
    private void updateCameraParameters() {
        if (camera != null) {
            ...
            try {
                ...
                cameraParamsInit = true;
                Log.i("zy_code", "ok");
            } catch (Exception e) {
                Camera.Parameters parameters = camera.getParameters();
                camera.setParameters(parameters);
                Log.i("zy_code", "try  catch");
            }
        }
    }
//    private void updateCameraParameters() {
...
//            setParameters(p);
//            try {
//                Log.i("zy_code","11111111111111111");
//                camera.setParameters(p);
//                Log.i("zy_code","22222222222222222");
//            } catch (Exception e) {
//                Camera.Parameters parameters = camera.getParameters();
//                camera.setParameters(parameters);
//
