...
import com.uuzuche.lib_zxing.decoding.CaptureActivityHandler2;
...
public class SearchISBNFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    private boolean playBeep;   //sound
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        if (handler == null) {
            handler = new CaptureActivityHandler2(this, decodeFormats, characterSet, viewfinderView);
        }
    }
    ...
    @Nullable
    CaptureFragment.CameraInitCallBack callBack;
